...
class KinestheticFeedbackNode(Node):
    """
    This node provides kinesthetic feedback to the human operator.
    ...
    Services
    --------
        set_applied_wrench (teleop_interfaces/srv/SetWrench) - Sets the wrench the
                                                               frankas will apply.
    ...
    def __init__(self):
        ...
        self.applied_wrench_set = self.create_service(SetWrench, "set_applied_wrench",
                                                      self.applied_wrench_set_callback)
    ...
    def limit_wrench(self):
        ...
        force_mag = np.sqrt(self.contact_wrench.force.x**2 +
                            self.contact_wrench.force.y**2 +
                            self.contact_wrench.force.z**2)
        ...
        torque_mag = np.sqrt(self.contact_wrench.torque.x**2 +
                             self.contact_wrench.torque.y**2 +
                             self.contact_wrench.torque.z**2)
