...
class HandPositionNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("z_offset", 0.0,
                               ParameterDescriptor(
                                   description="The z offset for the end effector"))
