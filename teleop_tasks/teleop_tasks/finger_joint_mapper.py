...
class Mapper(Node):
    ...
    def __init__(self):
        ...
        self.haptx_sub = self.create_subscription(JointState, "/haptx/lh/raw_joint_states", self.haptx_callback, 10)

        # Publish joint states for fingers in Gazebo
        self.gazebo_joint_pub = self.create_publisher(JointState, "/left_hand/joint_states", 10)
